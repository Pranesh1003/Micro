...
public class FlightServiceImpl implements FlightService {
    ...
    @Override
    public Flight findByFlightNumberOrId(String identifier) {
        if (identifier == null || identifier.isBlank()) {
            throw new FlightException("identifier is required");
        }
        try {
        ...
        return flightRepository.findByFlightNumberIgnoreCase(identifier.trim())
                .orElseThrow(() -> new FlightException(HttpStatus.NOT_FOUND, "Flight not found for identifier: " + identifier));
    }
}